...
const resources = [
  {
    ...
    title: 'AI Insights',
    description:
      'Actionable AI automation strategies, frameworks, and case studies for Florida businesses. Updated regularly by the NicheFinders team.',
    link: '/resources/ai-insights',
    tags: ['Strategy', 'Free'],
    accent: '#7aafd4',
    accentBg: 'rgba(122,175,212,0.1)',
    accentBorder: 'rgba(122,175,212,0.25)',
    icon: (
...
const categoryColors: Record<string, { bg: string; color: string; border: string }> = {
  ...
  Blog: { bg: 'rgba(122,175,212,0.1)', color: '#7aafd4', border: 'rgba(122,175,212,0.25)' },
};
      ...
      <Section background="navy-deepest" padding={false} glow>
        <Container size="lg" className="py-28 md:py-36 pb-36 md:pb-44 text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <Button href="/ai-os-partner-program" variant="secondary" size="lg" className="min-w-[240px]">
