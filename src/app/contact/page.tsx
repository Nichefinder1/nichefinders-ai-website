        ...
        <Container size="lg" className="pb-16">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
            ...
            <div className="rounded-xl overflow-hidden border border-white/10" style={{ height: '300px' }}>
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3573.5!2d-81.5232!3d27.4989!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2sNicheFinders+AI!5e0!3m2!1sen!2sus!4v1"
                width="100%"
                height="100%"
