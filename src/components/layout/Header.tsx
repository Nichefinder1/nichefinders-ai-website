...
export default function Header() {
  ...
  return (
    <>
          ...
          <div className="flex items-center justify-between h-20">
                    ...
                    <div className="p-4">
                      ...
                      <div className="grid grid-cols-2 gap-2">
                        {INDUSTRIES.map((industry) => {
                          const industryIconMap: { [key: string]: React.JSX.Element } = {
                            'home-services': (
            ...
            <button
              className={cn(
                ...
                isMobileMenuOpen || isScrolled ? 'text-navy-deep' : 'text-white'
              )}
      ...
      {isMobileMenuOpen && (
        <div className="lg:hidden fixed inset-0 top-24 bg-white z-[60] overflow-y-auto pointer-events-auto">
